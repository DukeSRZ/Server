...
import com.ax.manager.filter.KickoutSessionFilter;
import com.ax.manager.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        filterMap.put("/", "user");
        // Excel上传
        filterMap.put("/app/uploadAppList", "anon");
